...
const image = {
  uri: 'https://www.fonewalls.com/wp-content/uploads/2019/10/Gradient-Background-Wallpaper-009.jpg',
};
    ...
    return (
      <Tab.Navigator
        ...
        <Tab.Screen
          ...
          component={Income}
          onPress={() => {
            navigation.dispatch(navigation.navigate('Expense'));
          }}
          options={{
            tabBarIcon: ({focused}) => (
              <View
        ...
        <Tab.Screen
          ...
          component={Expense}
          onPress={() => {
            navigation.dispatch(navigation.navigate('Income'));
          }}
          options={{
            tabBarIcon: ({focused}) => (
              <View
